...
// Treasury - Available to authenticated users (staff and tenants)
     ...
     // Egresos y Gastos
     {
      ...
      },
      {
        ...
        name: 'PurchaseExpressEntry',
        component: () => import('@/views/admin/staff/inventory/PurchaseExpressEntryView.vue'),
        meta: { requiresAuth: true },
      },
      {
        path: '/admin/purchases/entry',
        name: 'PurchaseEntry',
        component: () => import('@/views/admin/staff/purchases/PurchaseEntryView.vue'),
        meta: { requiresAuth: true },
      },
      {
