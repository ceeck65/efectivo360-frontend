...
<template>
  <div class="max-w-6xl mx-auto px-4 py-8 space-y-8">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4"><div class="rounded-2xl border border-slate-200 bg-white p-5"><div class="flex items-center gap-2 mb-2"><TrendingUp class="h-4 w-4 text-emerald-500" /><span class="text-xs font-medium text-slate-500">Total Pendiente</span></div><div class="text-xl font-bold font-mono text-emerald-600">{{ formatAmount(kpi.total_pending, 'USD') }}</div></div><div class="rounded-2xl border border-slate-200 bg-white p-5"><div class="flex items-center gap-2 mb-2"><Clock class="h-4 w-4 text-amber-500" /><span class="text-xs font-medium text-slate-500">Vencidas</span></div><div class="text-xl font-bold font-mono text-amber-600">{{ kpi.overdue_count }} facturas</div></div></div>
    ...
    <div v-else class="overflow-x-auto rounded-xl border border-slate-200">
      <table class="w-full text-sm"><thead class="bg-slate-50 text-left"><tr><th class="px-4 py-3 font-medium text-slate-500 whitespace-nowrap">Cliente</th><th class="px-4 py-3 font-medium text-slate-500 whitespace-nowrap">Factura</th><th class="px-4 py-3 font-medium text-slate-500 text-right whitespace-nowrap">Total</th><th class="px-4 py-3 font-medium text-slate-500 text-right whitespace-nowrap">Saldo</th><th class="px-4 py-3 font-medium text-slate-500 whitespace-nowrap">Vence</th><th class="px-4 py-3 font-medium text-slate-500 whitespace-nowrap">Estado</th><th class="px-4 py-3 font-medium text-slate-500 text-right whitespace-nowrap"></th></tr></thead>
