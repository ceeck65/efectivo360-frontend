...
const mockTemplates = ref<PaymentMethodTemplate[]>([
  {
    ...
    logo: '',
    brand_color: '#6B1CB5',
    currency: { id: 1, code: 'USD', name: 'US Dollar', symbol: '$', decimal_precision: 2, symbol_position: 'prefix', thousand_separator: ',', decimal_separator: '.', is_active: true },
    category: { id: 1, name: 'Transferencia', slug: 'transfer', icon: 'arrow-left-right', sort_order: 1, is_active: true },
    payment_type: { id: 1, name: 'Inmediato', slug: 'immediate', description: 'Pago inmediato', sort_order: 1, is_active: true },
  ...
  },
  {
    ...
    brand_color: '#FCD535',
    currency: { id: 1, code: 'USD', name: 'US Dollar', symbol: '$', decimal_precision: 2, symbol_position: 'prefix', thousand_separator: ',', decimal_separator: '.', is_active: true },
    category: { id: 2, name: 'Cripto', slug: 'crypto', icon: 'bitcoin', sort_order: 2, is_active: true },
    payment_type: { id: 1, name: 'Inmediato', slug: 'immediate', description: 'Pago inmediato', sort_order: 1, is_active: true },
  ...
  },
  {
    ...
    logo: '',
    brand_color: '#0055A4',
    currency: { id: 2, code: 'VES', name: 'Bolívar Soberano', symbol: 'Bs', decimal_precision: 2, symbol_position: 'prefix', thousand_separator: '.', decimal_separator: ',', is_active: true },
    category: { id: 3, name: 'Transferencia Bancaria', slug: 'bank_transfer', icon: 'banknote', sort_order: 3, is_active: true },
    payment_type: { id: 1, name: 'Inmediato', slug: 'immediate', description: 'Pago inmediato', sort_order: 1, is_active: true },
...
export function useMockPaymentApi() {
  ...
  const createTemplate = async (formData: FormData) => {
    ...
    const newTemplate: PaymentMethodTemplate = {
      ...
      currency: { id: 1, code: 'USD', name: 'US Dollar', symbol: '$', decimal_precision: 2, symbol_position: 'prefix', thousand_separator: ',', decimal_separator: '.', is_active: true },
      category: { id: 1, name: 'General', slug: 'general', icon: 'folder', sort_order: 1, is_active: true },
      payment_type: { id: 1, name: 'Inmediato', slug: 'immediate', description: 'Pago inmediato', sort_order: 1, is_active: true },
